...
/* Function to print each pair of statements */
void print_statements(int language, TYPE *types) {
  ...
  case ENGLISH:
    ...
    statement("I have tended to be careful and hesitant.",
              "I have tended to be bold and domineering.", 'B', 'G',
              &types->b_6, &types->g_8);
    ...
    statement(
        ...
        "I've been appreciated for my deep caring and personal warmth.", 'I',
        'F', &types->i_7, &types->f_2);
    ...
    statement(
        ...
        "I have usually taken my social obligations very seriously.", 'E', 'B',
        &types->e_4, &types->b_6);
    ...
    statement("Typically, I have not had much self-discipline.",
              "Typically, I have not had much connection with people.", 'I',
    ...
    statement("I have tended to take a long time to get into action.",
              "I have tended to get into action quickly.", 'H', 'D',
              &types->h_5, &types->d_1);
    ...
    /* Statement Pair 99 */
    statement("When I have disliked people, I have usually tried hard to stay "
    ...
    /* Statement Pair 104 */
    statement("My thoughts generally have been speculative involving my "
              "imagination and "
              "curiosity.",
    ...
    /* Statement Pair 121 */
    statement("In the past, I've probably insisted on too much closeness in my "
              "friendships.",
    ...
    statement(
        ...
        "I've had a tendency to keep anticipating things I'm going to do.", 'E',
        'I', &types->e_4, &types->i_7);
    ...
    statement(
        ...
        "I've presented myself to others as caring more than I really do.", 'G',
        'F', &types->g_8, &types->f_2);
  ...
  case PORTUGUESE:
    ...
    statement(
        ...
        "Eu tenho dependido da minha imaginação e momentos de inspiração.", 'B',
    ...
    statement(
        ...
        "Eu tenho sido modesto e estado feliz em ir no meu próprio ritmo.", 'C',
        'A', &types->c_3, &types->a_9);

    /* Par de Frases 68 */
    statement(
        "Eu tenho me orgulhado da minha clareza e objetividade.",
        "Eu tenho me orgulhado da minha confiabilidade e comprometimento.", 'H',
        'B', &types->h_5, &types->b_6);
    ...
    statement("Eu tive uma mente ágil e energia ilimitada.",
              "Eu tive um coração acolhedor e uma profunda dedicação.", 'I',
              'F', &types->i_7, &types->f_2);
    ...
    /* Par de Frases 75 */
    statement("Ao longo dos anos, meus valores e estilo de vida mudaram várias "
              "vezes.",
    ...
    statement("Tipicamente, quando fico com raiva, eu repreendo as pessoas.",
              "Tipicamente, quando fico com raiva, me torno distante.", 'G',
    ...
    statement("Eu geralmente fui ponderado, franco e deliberado.",
              "Eu geralmente fui animado, espirituoso e falei rápido.", 'G',
              'I', &types->g_8, &types->i_7);
    ...
    /* Par de Frases 106 */
    statement("Eu pressionei as pessoas para que as coisas fossem feitas "
              "corretamente, "
              "até se isso "
    ...
    statement("Meu estilo pende à simplicidade e austeridade.",
              "Meu estilo pende ao excesso e ao exagero.", 'H', 'I',
              &types->h_5, &types->i_7);
    ...
    /* Par de Frases 117 */
    statement("Eu tenho sido determinado e persistente na busca pelos meus "
              "objetivos.",
    ...
    statement(
        ...
        "Eu tenho tido uma necessidade profunda de me sentir equilibrado.", 'B',
        'D', &types->b_6, &types->d_1);
    ...
    /* Par de Frases 133 */
    statement("Em geral, eu tenho sido uma pessoa altamente intuitiva e "
              "individualista.",
    ...
    /* Par de Frases 136 */
    statement("Eu geralmente tenho sido mente aberta e disposto a tentar novas "
              "abordagens.",
    ...
    /* Par de Frases 137 */
    statement("Eu me apresento aos outros como sendo mais durão do que "
              "realmente sou.",
