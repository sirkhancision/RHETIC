...
void print_instructions_en() {
  ...
  printf("\nThe most accurate approach to the test is to take it from the "
         "point of view of\n"
         "the past, as you have been most of your life.\n"
         "You must enter the letter that corresponds to the statement you want "
         "to select,\n"
         "without the brackets. If you're unsure of what to choose, you can "
         "skip the\n"
         "current pair by entering [>].\n");

  printf("\nThe profile you get from RHETI will reflect your personality's "
         "principal\n"
         "psychological functions, the balance of which changes over time. "
         "Your basic\n"
  ...
  printf("\n%sPLEASE NOTE!%s The accuracy of this test will be increased if "
         ...
         "self, and\n"
         "our self as others see us. The RHETI is attempting to discern only "
         "your past\n"
...
void print_result_en(int a, int b, int c, int d, int e, int f, int g, int h,
                     int i) {
