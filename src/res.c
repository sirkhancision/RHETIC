 ...
 * the test's answers */
short unsigned int res_type(int a, int b, int c, int d, int e, int f, int g,
                            int h, int i) {
  short unsigned int feel, think, instinct, assertive, dutiful, withdrawn,
      positive, reactive, competency, n, types[9];
...
short unsigned int res_wing(int a, int b, int c, int d, int e, int f, int g,
                            int h, int i) {
