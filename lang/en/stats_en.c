...
void stats_eng(void) {
	...
	"my life. [F]", "I have been a private person and have not mixed much with others. [E]", 'F', 'E', &f_type2, &e_type4);

	/* Statement Pair 6 */
	stats_form("6.It's been difficult for me to relax and stop worrying about potential\n"
	"problems. [B]", "It's been difficult for me to get myself worked up about potential problems. [A]", 'B', 'A', &b_type6, &a_type9);
	...
	"be enjoyable. [I]", 'C', 'I', &c_type3, &i_type7);
	...
	/* Statement Pair 13 */
	stats_form("13.I have been more relationship-oriented than goal-oriented. [F]", "I have been more goal-oriented than relationship-oriented. [C]", 'F', 'C', &f_type2, &c_type3);
	...
	"say. [I]", 'E', 'I', &e_type4, &i_type7);

	/* Statement Pair 15 */
	stats_form("15.It's been difficult for me to stop considering alternatives and do something\n"
	"definite. [H]", "It's been difficult for me to take it easy and be more flexible. [D]", 'H', 'D', &h_type5, &d_type1);
	...
	"them. [F]", 'A', 'F', &a_type9, &f_type2);

	/* Statement Pair 18 */
	stats_form("18.Usually, I have been able to put my feelings aside to get the job done. [C]",
	"Usually, I have needed to work through my feelings before I could act. [E]", 'C', 'E', &c_type3, &e_type4);
	...
	"others. [F]", "I have tended to be a serious, reserved person who likes discussing issues. [D]", 'F', 'D', &f_type2, &d_type1);
	...
	"stimulation. [I]", 'A', 'I', &a_type9, &i_type7);

	/* Statement Pair 27 */
	stats_form("27.I have depended on my friends and they have known that they can depend\n"
	"on me. [B]", "I have not depended on people, I have done things on my own. [C]", 'B', 'C', &b_type6, &c_type3);
	...
	"personal interests. [B]", 'H', 'B', &h_type5, &b_type6);

	/* Statement Pair 33 */
	stats_form("33.When I've had conflicts with others, I've tended to withdraw. [E]", "When I've had conflicts with others, I've rarely backed down. [G]", 'E', 'G', &e_type4, &g_type8);

	/* Statement Pair 34 */
	stats_form("34.I have given in too easily and let others push me around. [A]", "I have been too uncompromising and demanding with others. [D]", 'A', 'D', &a_type9, &d_type1);

	/* Statement Pair 35 */
	stats_form("35.I've been appreciated for my unsinkable spirit and resourcefulness. [I]", "I've been appreciated for my deep caring and personal warmth. [F]", 'I', 'F', &i_type7, &f_type2);

	/* Statement Pair 36 */
	stats_form("36.I have wanted to make a favorable impression on others. [C]", "I have cared little about making a favorable impression on others. [H]", 'C', 'H', &c_type3, &h_type5);
	...
	"Being accepted and well-liked has not been a high priority for me. [D]", 'C', 'D', &c_type3, &d_type1);

	/* Statement Pair 40 */
	stats_form("40.In reaction to pressure from others, I have become more withdrawn. [H]", "In reaction to pressure from others, I have become more assertive. [I]", 'H', 'I', &h_type5, &i_type7);
	...
	/* Statement Pair 42 */
	stats_form("42.Duty and responsibility have been important values for me. [B]", "Harmony and acceptance have been important values for me. [A]", 'B', 'A', &b_type6, &a_type9);
	...
	"following my advice. [D]", 'G', 'D', &g_type8, &d_type1);
	...
	"my family. [A]", 'E', 'A', &e_type4, &a_type9);
	...
	"of things. [G]", 'H', 'G', &h_type5, &g_type8);

	/* Statement Pair 48 */
	stats_form("48.I have stood by my friends, even when they have been wrong. [B]", "I have not wanted to compromised what is right, even for friendship. [D]", 'B', 'D', &b_type6, &d_type1);
	...
	/* Statement Pair 50 */
	stats_form("50.When troubled, I have tended to brood about my problems. [E]", "When troubled, I have tended to find distractions for myself. [I]", 'E', 'I', &e_type4, &i_type7);
	...
	"to be. [H]", 'D', 'H', &d_type1, &h_type5);

	/* Statement Pair 52 */
	stats_form("52.I've created problems with others by being pessimistic and complaining. [B]", "I've created problems with others by being bossy and controlling. [G]", 'B', 'G', &b_type6, &g_type8);

	/* Statement Pair 53 */
	stats_form("53.I have tended to act on my feelings and let the \"chips fall where they may\". [F]", "I have tended not to act on my feelings lest they stir up more problems. [A]", 'F', 'A', &f_type2, &a_type9);

	/* Statement Pair 54 */
	stats_form("54.Being the center of attention has usually felt natural to me. [C]", "Being the center of attention has usually felt strange to me. [E]", 'C', 'E', &c_type3, &e_type4);

	/* Statement Pair 55 */
	stats_form("55.I've been careful and have tried to prepare for unforeseen problems. [B]", "I've been spontaneous and have preferred to improvise as problems come up. [I]", 'B', 'I', &b_type6, &i_type7);

	/* Statement Pair 56 */
	stats_form("56.I have gotten angry when others have not shown enough appreciation for what\n"
	"I have done for them. [F]", "I have gotten angry when others have not listened to what I have told them. [D]", 'F', 'D', &f_type2, &d_type1);

	/* Statement Pair 57 */
	stats_form("57.Being independent and self-reliant has been important to me. [G]", "Being valued and admired has been important to me. [C]", 'G', 'C', &g_type8, &c_type3);
	...
	"feelings. [A]", 'H', 'A', &h_type5, &a_type9);

	/* Statement Pair 59 */
	stats_form("59.I have often been possessive of loved ones – I have had trouble letting\n"
	"them be. [F]", "I have often \"tested\" loved ones to see if they were really there for me. [B]", 'F', 'B', &f_type2, &b_type6);
	...
	"my major strengths. [I]", 'G', 'I', &g_type8, &i_type7);
	...
	/* Statement Pair 62 */
	stats_form("62.I have tried to keep my life fast-paced, intense, and exciting. [I]", "I have tried to keep my life regular, stable, and peaceful. [A]", 'I', 'A', &i_type7, &a_type9);

	/* Statement Pair 63 */
	stats_form("63.Even though I've had successes, I've tended to doubt my abilities. [B]", "Even though I've had setbacks, I've had a lot of confidence in my abilities. [C]", 'B', 'C', &b_type6, &c_type3);
	...
	"to them. [H]",	'E', 'H', &e_type4, &h_type5);

	/* Statement Pair 65 */
	stats_form("65.I have provided many people with attention and nurturance. [F]",	"I have provided many people with direction and motivation. [G]", 'F', 'G', &f_type2, &g_type8);
	...
	"important to me. [G]", 'E', 'G', &e_type4, &g_type8);

	/* Statement Pair 70 */
	stats_form("70.Generally, I have thought of myself as a sunny, casual person. [A]", "Generally, I have thought of myself as a serious, dignified person. [D]", 'A', 'D', &a_type9, &d_type1);
	...
	"work I was really interested in. [H]", 'C', 'H', &c_type3, &h_type5);

	/* Statement Pair 73 */
	stats_form("73.Fulfilling social obligations has seldom been high on my agenda. [E]", "I have usually taken my social obligations very seriously. [B]", 'E', 'B', &e_type4, &b_type6);

	/* Statement Pair 74 */
	stats_form("74.In most situations, I have preferred to take the lead. [G]", "In most situations, I have preferred to let someone else take the lead. [A]", 'G', 'A', &g_type8, &a_type9);

	/* Statement Pair 75 */
	stats_form("75.Over the years, my values and lifestyle have changed several times. [C]", "Over the years, my values and lifestyle have remained fairly consistent. [D]", 'C', 'D', &c_type3, &d_type1);
	...
	"myself to others. [F]", 'E', 'F', &e_type4, &f_type2);

	/* Statement Pair 78 */
	stats_form("78.I have had a tendency to think of worst-case scenarios. [B]", "I have had a tendency to think that everything will work out for the best. [A]", 'B', 'A', &b_type6, &a_type9);

	/* Statement Pair 79 */
	stats_form("79.People have trusted me because I am confident and can look out for them. [G]",
	"People have trusted me because I am fair and will do what is right. [D]", 'G', 'D', &g_type8, &d_type1);
	...
	"projects. [F]", 'H', 'F', &h_type5, &f_type2);

	/* Statement Pair 81 */
	stats_form("81.When meeting someone new, I have usually been poised and self-contained. [C]", "When meeting someone new, I have usually been chatty and entertaining. [I]", 'C', 'I', &c_type3, &i_type7);
	...
	/* Statement Pair 84 */
	stats_form("84.I have often been troubled by nervousness, insecurity, and doubt. [B]", "I have often been troubled by anger, perfectionism, and impatience. [D]", 'B', 'D', &b_type6, &d_type1);

	/* Statement Pair 85 */
	stats_form("85.I realize that I have often been too personal and intimate. [F]", "I realize that I have often been too cool and aloof. [C]", 'F', 'C', &f_type2, &c_type3);

	/* Statement Pair 86 */
	stats_form("86.I have lost out because I have not felt up to taking opportunities. [E]", "I have lost out because I have pursued too many possibilities. [I]", 'E', 'I', &e_type4, &i_type7);
	...
	/* Statement Pair 89 */
	stats_form("89.I have had a tendency to come on a little too strong with people. [F]", "I have had a tendency not to assert myself enough with people. [A]", 'F', 'A', &f_type2, &a_type9);
	...
	"worked best for me. [I]", 'B', 'I', &b_type6, &i_type7);
	...
	"to do. [D]", 'F', 'D', &f_type2, &d_type1);

	/* Statement Pair 93 */
	stats_form("93.Typically, when I have gotten angry, I have told people off. [G]", "Typically, when I have gotten angry, I have become distant. [C]", 'G', 'C', &g_type8, &c_type3);
	...
	/* Statement Pair 95 */
	stats_form("95.I have often tried to figure out how I could get closer to others. [F]", "I have often tried to figure out what others want from me. [B]", 'F', 'B', &f_type2, &b_type6);

	/* Statement Pair 96 */
	stats_form("96.I have usually been measured, straight-talking, and deliberate. [G]", "I have usually been excitable, fast-talking, and witty. [I]", 'G', 'I', &g_type8, &i_type7);

	/* Statement Pair 97 */
	stats_form("97.Often, I have not spoken up when I've seen others making a mistake. [E]", "Often, I have helped others see that they are making a mistake. [D]", 'E', 'D', &e_type4, &d_type1);
	...
	"conventions. [H]", 'E', 'H', &e_type4, &h_type5);
	...
	/* Statement Pair 102 */
	stats_form("102.Generally, I have enjoyed \"letting go\" and pushing the limits. [I]", "Generally, I have not enjoyed losing control of myself very much. [D]", 'I', 'D', &i_type7, &d_type1);

	/* Statement Pair 103 */
	stats_form("103.I've been overly concerned with doing better than others. [C]", "I've been overly concerned with making things okay for others. [A]", 'C', 'A', &c_type3, &a_type9);
	...
	"going. [B]", 'H', 'B', &h_type5, &b_type6);

	/* Statement Pair 105 */
	stats_form("105.One of my main assets has been my ability to take charge of situations. [G]", "One of my main assets has been my ability to describe internal states. [E]", 'G', 'E', &g_type8, &e_type4);
	...
	"else. [A]", 'D', 'A', &d_type1, &a_type9);

	/* Statement Pair 107 */
	stats_form("107.I've often taken pride in how important I am in others's lives. [F]", "I've often taken pride in my gusto and openness to new experiences. [I]", 'F', 'I', &f_type2, &i_type7);

	/* Statement Pair 108 */
	stats_form("108.I have perceived that I've often come across to others as presentable,\n"
	"even admirable. [C]", "I have perceived that I've often come across to others as unusual, even odd. [H]", 'C', 'H', &c_type3, &h_type5);
	...
	/* Statement Pair 110 */
	stats_form("110.I have usually enjoyed high-pressure, even difficult, situations. [G]", "I have usually disliked being in high-pressured, even difficult, situations. [A]", 'G', 'A', &g_type8, &a_type9);
	...
	"believe in. [D]", 'C', 'D', &c_type3, &d_type1);
	...
	"personal needs. [E]", 'F', 'E', &f_type2, &e_type4);
	...
	"for me. [H]", 'F', 'H', &f_type2, &h_type5);

	/* Statement Pair 117 */
	stats_form("117.I've been single-minded and persistent in pursuing my goals. [C]", "I've preferred to explore various courses of action to see where they lead. [I]", 'C', 'I', &c_type3, &i_type7);
	...
	"at ease. [A]", 'E', 'A', &e_type4, &a_type9);

	/* Statement Pair 119 */
	stats_form("119.I have cared less about practical results than about pursuing my\n"
	"interests. [H]", "I have been practical and have expected my work to have concrete results. [G]", 'H', 'G', &h_type5, &g_type8);
	...
	"friendships. [F]", "In the past, I've probably kept too much distance in my relationships. [C]", 'F', 'C', &f_type2, &c_type3);

	/* Statement Pair 122 */
	stats_form("122.I've had a tendency to keep thinking about things from the past. [E]", "I've had a tendency to keep anticipating things I'm going to do. [I]", 'E', 'I', &e_type4, &i_type7);

	/* Statement Pair 123 */
	stats_form("123.I've tended to see people as intrusive and demanding. [H]", "I've tended to see people as disorganized and irresponsible. [D]", 'H', 'D', &h_type5, &d_type1);
	...
	/* Statement Pair 126 */
	stats_form("126.I've frequently been stopped in my tracks by my self-doubt. [E]", "I've rarely let self-doubt stand in my way. [C]", 'E', 'C', &e_type4, &c_type3);
	...
	"something I might not like? [B]", 'I', 'B', &i_type7, &b_type6);

	/* Statement Pair 128 */
	stats_form("128.I have given a lot of physical contact to reassure others about how I feel\n"
	"about them. [F]", "I have generally felt that real love does not depend on physical contact. [D]", 'F', 'D', &f_type2, &d_type1);
	...
	"too much. [C]", 'G', 'C', &g_type8, &c_type3);
	...
	"subjects. [A]", 'H', 'A', &h_type5, &a_type9);
	...
	"uncommunicative. [B]", 'F', 'B', &f_type2, &b_type6);
	...
	"really fulfill me. [I]", 'G', 'I', &g_type8, &i_type7);

	/* Statement Pair 133 */
	stats_form("133.Generally, I've been a highly intuitive, individualistic person. [E]", "Generally, I've been a highly organized, responsible person. [D]", 'E', 'D', &e_type4, &d_type1);
	...
	"argumentative. [B]", 'C', 'B', &c_type3, &b_type6);
	...
	"others. [E]", 'H', 'E', &h_type5, &e_type4);

	/* Statement Pair 137 */
	stats_form("137.I've presented myself to others as tougher than I really am. [G]", "I've presented myself to others as caring more than I really do. [F]", 'G', 'F', &g_type8, &f_type2);
	...
	/* Statement Pair 139 */
	stats_form("139.Serious adversity has made me feel hardened and resolute. [C]", "Serious adversity has made me feel discouraged and resign. [A]", 'C', 'A', &c_type3, &a_type9);
	...
	"possible. [H]", 'B', 'H', &b_type6, &h_type5);
	...
	"to be strong for others. [E]", 'G', 'E', &g_type8, &e_type4);
	...
	"messed up. [D]", 'A', 'D', &a_type9, &d_type1);
	...
	"people's expectations of me. [C]", 'H', 'C', &h_type5, &c_type3);
}
