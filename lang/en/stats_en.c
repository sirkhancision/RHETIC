...
void stats_eng(void) {
	...
	"I've been pragmatic and down-to-earth. [B]", 'E', 'B', &types_global.e_4, &types_global.b_6);

	/* Statement Pair 2 */
	stats_form("2.I have tended to take on confrontations. [G]",
	"I have tended to avoid confrontations. [A]", 'G', 'A', &types_global.g_8, &types_global.a_9);
	...
	'D', &types_global.c_3, &types_global.d_1);
	...
	"my life. [F]", "I have been a private person and have not mixed much with others. [E]", 'F', 'E', &types_global.f_2, &types_global.e_4);

	/* Statement Pair 6 */
	stats_form("6.It's been difficult for me to relax and stop worrying about potential\n"
	"problems. [B]", "It's been difficult for me to get myself worked up about potential problems. [A]", 'B', 'A', &types_global.b_6, &types_global.a_9);
	...
	'H', &types_global.f_2, &types_global.h_5);
	...
	"be enjoyable. [I]", 'C', 'I', &types_global.c_3, &types_global.i_7);
	...
	'G', &types_global.h_5, &types_global.g_8);
	...
	/* Statement Pair 13 */
	stats_form("13.I have been more relationship-oriented than goal-oriented. [F]", "I have been more goal-oriented than relationship-oriented. [C]", 'F', 'C', &types_global.f_2, &types_global.c_3);
	...
	"say. [I]", 'E', 'I', &types_global.e_4, &types_global.i_7);

	/* Statement Pair 15 */
	stats_form("15.It's been difficult for me to stop considering alternatives and do something\n"
	"definite. [H]", "It's been difficult for me to take it easy and be more flexible. [D]", 'H', 'D', &types_global.h_5, &types_global.d_1);
	...
	"mind. [A]", 'H', 'A', &types_global.h_5, &types_global.a_9);

	/* Statement Pair 23 */
	stats_form("23.I've been a bit cynical and skeptical. [B]",
	"I've been a bit mushy and sentimental. [F]", 'B', 'F', &types_global.b_6, &types_global.f_2);
	...
	"of me. [G]", 'I', 'G', &types_global.i_7, &types_global.g_8);
	...
	&types_global.g_8, &types_global.f_2);
	...
	'I', 'D', &types_global.i_7, &types_global.d_1);
	...
	'A', 'C', &types_global.a_9, &types_global.c_3);
	...
	"personal interests. [B]", 'H', 'B', &types_global.h_5, &types_global.b_6);

	/* Statement Pair 33 */
	stats_form("33.When I've had conflicts with others, I've tended to withdraw. [E]", "When I've had conflicts with others, I've rarely backed down. [G]", 'E', 'G', &types_global.e_4, &types_global.g_8);

	/* Statement Pair 34 */
	stats_form("34.I have given in too easily and let others push me around. [A]", "I have been too uncompromising and demanding with others. [D]", 'A', 'D', &types_global.a_9, &types_global.d_1);

	/* Statement Pair 35 */
	stats_form("35.I've been appreciated for my unsinkable spirit and resourcefulness. [I]", "I've been appreciated for my deep caring and personal warmth. [F]", 'I', 'F', &types_global.i_7, &types_global.f_2);

	/* Statement Pair 36 */
	stats_form("36.I have wanted to make a favorable impression on others. [C]", "I have cared little about making a favorable impression on others. [H]", 'C', 'H', &types_global.c_3, &types_global.h_5);
	...
	'B', 'E', &types_global.b_6, &types_global.e_4);
	...
	"Being accepted and well-liked has not been a high priority for me. [D]", 'C', 'D', &types_global.c_3, &types_global.d_1);

	/* Statement Pair 40 */
	stats_form("40.In reaction to pressure from others, I have become more withdrawn. [H]", "In reaction to pressure from others, I have become more assertive. [I]", 'H', 'I', &types_global.h_5, &types_global.i_7);
	...
	'F', 'E', &types_global.f_2, &types_global.e_4);

	/* Statement Pair 42 */
	stats_form("42.Duty and responsibility have been important values for me. [B]", "Harmony and acceptance have been important values for me. [A]", 'B', 'A', &types_global.b_6, &types_global.a_9);
	...
	"my family. [A]", 'E', 'A', &types_global.e_4, &types_global.a_9);
	...
	"of things. [G]", 'H', 'G', &types_global.h_5, &types_global.g_8);

	/* Statement Pair 48 */
	stats_form("48.I have stood by my friends, even when they have been wrong. [B]", "I have not wanted to compromised what is right, even for friendship. [D]", 'B', 'D', &types_global.b_6, &types_global.d_1);

	/* Statement Pair 49 */
	stats_form("49.I've been a well-meaning supporter. [F]",
	"I've been a highly-motivated go-getter. [C]", 'F', 'C', &types_global.f_2, &types_global.c_3);

	/* Statement Pair 50 */
	stats_form("50.When troubled, I have tended to brood about my problems. [E]", "When troubled, I have tended to find distractions for myself. [I]", 'E', 'I', &types_global.e_4, &types_global.i_7);
	...
	"to be. [H]", 'D', 'H', &types_global.d_1, &types_global.h_5);

	/* Statement Pair 52 */
	stats_form("52.I've created problems with others by being pessimistic and complaining. [B]", "I've created problems with others by being bossy and controlling. [G]", 'B', 'G', &types_global.b_6, &types_global.g_8);

	/* Statement Pair 53 */
	stats_form("53.I have tended to act on my feelings and let the \"chips fall where they may\". [F]", "I have tended not to act on my feelings lest they stir up more problems. [A]", 'F', 'A', &types_global.f_2, &types_global.a_9);

	/* Statement Pair 54 */
	stats_form("54.Being the center of attention has usually felt natural to me. [C]", "Being the center of attention has usually felt strange to me. [E]", 'C', 'E', &types_global.c_3, &types_global.e_4);

	/* Statement Pair 55 */
	stats_form("55.I've been careful and have tried to prepare for unforeseen problems. [B]", "I've been spontaneous and have preferred to improvise as problems come up. [I]", 'B', 'I', &types_global.b_6, &types_global.i_7);

	/* Statement Pair 56 */
	stats_form("56.I have gotten angry when others have not shown enough appreciation for what\n"
	"I have done for them. [F]", "I have gotten angry when others have not listened to what I have told them. [D]", 'F', 'D', &types_global.f_2, &types_global.d_1);

	/* Statement Pair 57 */
	stats_form("57.Being independent and self-reliant has been important to me. [G]", "Being valued and admired has been important to me. [C]", 'G', 'C', &types_global.g_8, &types_global.c_3);
	...
	"feelings. [A]", 'H', 'A', &types_global.h_5, &types_global.a_9);

	/* Statement Pair 59 */
	stats_form("59.I have often been possessive of loved ones – I have had trouble letting\n"
	"them be. [F]", "I have often \"tested\" loved ones to see if they were really there for me. [B]", 'F', 'B', &types_global.f_2, &types_global.b_6);
	...
	"my major strengths. [I]", 'G', 'I', &types_global.g_8, &types_global.i_7);
	...
	'D', 'E', &types_global.d_1, &types_global.e_4);

	/* Statement Pair 62 */
	stats_form("62.I have tried to keep my life fast-paced, intense, and exciting. [I]", "I have tried to keep my life regular, stable, and peaceful. [A]", 'I', 'A', &types_global.i_7, &types_global.a_9);

	/* Statement Pair 63 */
	stats_form("63.Even though I've had successes, I've tended to doubt my abilities. [B]", "Even though I've had setbacks, I've had a lot of confidence in my abilities. [C]", 'B', 'C', &types_global.b_6, &types_global.c_3);
	...
	"important to me. [G]", 'E', 'G', &types_global.e_4, &types_global.g_8);

	/* Statement Pair 70 */
	stats_form("70.Generally, I have thought of myself as a sunny, casual person. [A]", "Generally, I have thought of myself as a serious, dignified person. [D]", 'A', 'D', &types_global.a_9, &types_global.d_1);

	/* Statement Pair 71 */
	stats_form("71.I've had an agile mind and boundless energy. [I]",
	"I've had a caring heart and deep dedication. [F]", 'I', 'F',
	&types_global.i_7, &types_global.f_2);
	...
	"work I was really interested in. [H]", 'C', 'H', &types_global.c_3, &types_global.h_5);

	/* Statement Pair 73 */
	stats_form("73.Fulfilling social obligations has seldom been high on my agenda. [E]", "I have usually taken my social obligations very seriously. [B]", 'E', 'B', &types_global.e_4, &types_global.b_6);

	/* Statement Pair 74 */
	stats_form("74.In most situations, I have preferred to take the lead. [G]", "In most situations, I have preferred to let someone else take the lead. [A]", 'G', 'A', &types_global.g_8, &types_global.a_9);

	/* Statement Pair 75 */
	stats_form("75.Over the years, my values and lifestyle have changed several times. [C]", "Over the years, my values and lifestyle have remained fairly consistent. [D]", 'C', 'D', &types_global.c_3, &types_global.d_1);
	...
	"myself to others. [F]", 'E', 'F', &types_global.e_4, &types_global.f_2);

	/* Statement Pair 78 */
	stats_form("78.I have had a tendency to think of worst-case scenarios. [B]", "I have had a tendency to think that everything will work out for the best. [A]", 'B', 'A', &types_global.b_6, &types_global.a_9);

	/* Statement Pair 79 */
	stats_form("79.People have trusted me because I am confident and can look out for them. [G]",
	"People have trusted me because I am fair and will do what is right. [D]", 'G', 'D', &types_global.g_8, &types_global.d_1);
	...
	"projects. [F]", 'H', 'F', &types_global.h_5, &types_global.f_2);

	/* Statement Pair 81 */
	stats_form("81.When meeting someone new, I have usually been poised and self-contained. [C]", "When meeting someone new, I have usually been chatty and entertaining. [I]", 'C', 'I', &types_global.c_3, &types_global.i_7);

	/* Statement Pair 82 */
	stats_form("82.Generally speaking, I have tended to be pessimistic. [E]", "Generally speaking, I have tended to be optimistic. [A]", 'E',
	'A', &types_global.e_4, &types_global.a_9);

	/* Statement Pair 83 */
	stats_form("83.I have preferred to inhabit my own little world. [H]",
	"I have preferred to let the world know I'm here. [G]", 'H', 'G',
	&types_global.h_5, &types_global.g_8);

	/* Statement Pair 84 */
	stats_form("84.I have often been troubled by nervousness, insecurity, and doubt. [B]", "I have often been troubled by anger, perfectionism, and impatience. [D]", 'B', 'D', &types_global.b_6, &types_global.d_1);

	/* Statement Pair 85 */
	stats_form("85.I realize that I have often been too personal and intimate. [F]", "I realize that I have often been too cool and aloof. [C]", 'F', 'C', &types_global.f_2, &types_global.c_3);

	/* Statement Pair 86 */
	stats_form("86.I have lost out because I have not felt up to taking opportunities. [E]", "I have lost out because I have pursued too many possibilities. [I]", 'E', 'I', &types_global.e_4, &types_global.i_7);

	/* Statement Pair 87 */
	stats_form("87.I have tended to take a long time to get into action. [H]", "I have tended to get into action quickly. [D]", 'H', 'D',
	&types_global.h_5, &types_global.d_1);
	...
	/* Statement Pair 89 */
	stats_form("89.I have had a tendency to come on a little too strong with people. [F]", "I have had a tendency not to assert myself enough with people. [A]", 'F', 'A', &types_global.f_2, &types_global.a_9);

	/* Statement Pair 90 */
	stats_form("90.Typically, I have been even-tempered. [C]",
	"Typically, I have had strong changes of mood. [E]", 'C', 'E',
	&types_global.c_3, &types_global.e_4);
	...
	"worked best for me. [I]", 'B', 'I', &types_global.b_6, &types_global.i_7);
	...
	"to do. [D]", 'F', 'D', &types_global.f_2, &types_global.d_1);

	/* Statement Pair 93 */
	stats_form("93.Typically, when I have gotten angry, I have told people off. [G]", "Typically, when I have gotten angry, I have become distant. [C]", 'G', 'C', &types_global.g_8, &types_global.c_3);

	/* Statement Pair 94 */
	stats_form("94.I've tended to have trouble falling asleep. [H]",
	"I've tended to fall asleep easily. [A]", 'H', 'A', &types_global.h_5,
	&types_global.a_9);

	/* Statement Pair 95 */
	stats_form("95.I have often tried to figure out how I could get closer to others. [F]", "I have often tried to figure out what others want from me. [B]", 'F', 'B', &types_global.f_2, &types_global.b_6);

	/* Statement Pair 96 */
	stats_form("96.I have usually been measured, straight-talking, and deliberate. [G]", "I have usually been excitable, fast-talking, and witty. [I]", 'G', 'I', &types_global.g_8, &types_global.i_7);

	/* Statement Pair 97 */
	stats_form("97.Often, I have not spoken up when I've seen others making a mistake. [E]", "Often, I have helped others see that they are making a mistake. [D]", 'E', 'D', &types_global.e_4, &types_global.d_1);
	...
	"deep\". [A]", 'I', 'A', &types_global.i_7, &types_global.a_9);
	...
	"another. [B]", 'C', 'B', &types_global.c_3, &types_global.b_6);
	...
	"conventions. [H]", 'E', 'H', &types_global.e_4, &types_global.h_5);
	...
	/* Statement Pair 102 */
	stats_form("102.Generally, I have enjoyed \"letting go\" and pushing the limits. [I]", "Generally, I have not enjoyed losing control of myself very much. [D]", 'I', 'D', &types_global.i_7, &types_global.d_1);

	/* Statement Pair 103 */
	stats_form("103.I've been overly concerned with doing better than others. [C]", "I've been overly concerned with making things okay for others. [A]", 'C', 'A', &types_global.c_3, &types_global.a_9);
	...
	"going. [B]", 'H', 'B', &types_global.h_5, &types_global.b_6);

	/* Statement Pair 105 */
	stats_form("105.One of my main assets has been my ability to take charge of situations. [G]", "One of my main assets has been my ability to describe internal states. [E]", 'G', 'E', &types_global.g_8, &types_global.e_4);
	...
	"else. [A]", 'D', 'A', &types_global.d_1, &types_global.a_9);

	/* Statement Pair 107 */
	stats_form("107.I've often taken pride in how important I am in others's lives. [F]", "I've often taken pride in my gusto and openness to new experiences. [I]", 'F', 'I', &types_global.f_2, &types_global.i_7);

	/* Statement Pair 108 */
	stats_form("108.I have perceived that I've often come across to others as presentable,\n"
	"even admirable. [C]", "I have perceived that I've often come across to others as unusual, even odd. [H]", 'C', 'H', &types_global.c_3, &types_global.h_5);

	/* Statement Pair 109 */
	stats_form("109.I've mostly done what I had to do. [B]",
	"I've mostly done what I wanted to do. [E]", 'B', 'E', &types_global.b_6, &types_global.e_4);

	/* Statement Pair 110 */
	stats_form("110.I have usually enjoyed high-pressure, even difficult, situations. [G]", "I have usually disliked being in high-pressured, even difficult, situations. [A]", 'G', 'A', &types_global.g_8, &types_global.a_9);
	...
	"believe in. [D]", 'C', 'D', &types_global.c_3, &types_global.d_1);
	...
	'H', 'I', &types_global.h_5, &types_global.i_7);
	...
	'G', 'D', &types_global.g_8, &types_global.d_1);
	...
	"for me. [H]", 'F', 'H', &types_global.f_2, &types_global.h_5);

	/* Statement Pair 117 */
	stats_form("117.I've been single-minded and persistent in pursuing my goals. [C]", "I've preferred to explore various courses of action to see where they lead. [I]", 'C', 'I', &types_global.c_3, &types_global.i_7);
	...
	"at ease. [A]", 'E', 'A', &types_global.e_4, &types_global.a_9);

	/* Statement Pair 119 */
	stats_form("119.I have cared less about practical results than about pursuing my\n"
	"interests. [H]", "I have been practical and have expected my work to have concrete results. [G]", 'H', 'G', &types_global.h_5, &types_global.g_8);

	/* Statement Pair 120 */
	stats_form("120.I have had a deep need to belong. [B]",
	"I have had a deep need to feel balanced. [D]", 'B', 'D', &types_global.b_6, &types_global.d_1);

	/* Statement Pair 121 */
	stats_form("121.In the past, I've probably insisted on too much closeness in my\n"
	"friendships. [F]", "In the past, I've probably kept too much distance in my relationships. [C]", 'F', 'C', &types_global.f_2, &types_global.c_3);

	/* Statement Pair 122 */
	stats_form("122.I've had a tendency to keep thinking about things from the past. [E]", "I've had a tendency to keep anticipating things I'm going to do. [I]", 'E', 'I', &types_global.e_4, &types_global.i_7);

	/* Statement Pair 123 */
	stats_form("123.I've tended to see people as intrusive and demanding. [H]", "I've tended to see people as disorganized and irresponsible. [D]", 'H', 'D', &types_global.h_5, &types_global.d_1);
	...
	'F', &types_global.a_9, &types_global.f_2);

	/* Statement Pair 126 */
	stats_form("126.I've frequently been stopped in my tracks by my self-doubt. [E]", "I've rarely let self-doubt stand in my way. [C]", 'E', 'C', &types_global.e_4, &types_global.c_3);
	...
	"something I might not like? [B]", 'I', 'B', &types_global.i_7, &types_global.b_6);

	/* Statement Pair 128 */
	stats_form("128.I have given a lot of physical contact to reassure others about how I feel\n"
	"about them. [F]", "I have generally felt that real love does not depend on physical contact. [D]", 'F', 'D', &types_global.f_2, &types_global.d_1);
	...
	"too much. [C]", 'G', 'C', &types_global.g_8, &types_global.c_3);
	...
	"subjects. [A]", 'H', 'A', &types_global.h_5, &types_global.a_9);
	...
	"uncommunicative. [B]", 'F', 'B', &types_global.f_2, &types_global.b_6);
	...
	"really fulfill me. [I]", 'G', 'I', &types_global.g_8, &types_global.i_7);

	/* Statement Pair 133 */
	stats_form("133.Generally, I've been a highly intuitive, individualistic person. [E]", "Generally, I've been a highly organized, responsible person. [D]", 'E', 'D', &types_global.e_4, &types_global.d_1);
	...
	'A', 'I', &types_global.a_9, &types_global.i_7);
	...
	"argumentative. [B]", 'C', 'B', &types_global.c_3, &types_global.b_6);
	...
	"others. [E]", 'H', 'E', &types_global.h_5, &types_global.e_4);

	/* Statement Pair 137 */
	stats_form("137.I've presented myself to others as tougher than I really am. [G]", "I've presented myself to others as caring more than I really do. [F]", 'G', 'F', &types_global.g_8, &types_global.f_2);
	...
	/* Statement Pair 139 */
	stats_form("139.Serious adversity has made me feel hardened and resolute. [C]", "Serious adversity has made me feel discouraged and resign. [A]", 'C', 'A', &types_global.c_3, &types_global.a_9);
	...
	"possible. [H]", 'B', 'H', &types_global.b_6, &types_global.h_5);
	...
	"to be strong for others. [E]", 'G', 'E', &types_global.g_8, &types_global.e_4);
	...
	"messed up. [D]", 'A', 'D', &types_global.a_9, &types_global.d_1);
	...
	'I', &types_global.f_2, &types_global.i_7);
	...
	"people's expectations of me. [C]", 'H', 'C', &types_global.h_5, &types_global.c_3);
}
