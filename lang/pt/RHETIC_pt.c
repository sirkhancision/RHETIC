...
void print_greet_pt() {
  printf("Bem-vindo ao %sRHETIC%s, o Indicador de Tipo do Eneagrama de "
         "Riso-Hudson\n"
         "(RHETI) em C!\n"
         "Entre com [1] para seguir com as instruções, ou [2] para ir direto "
         "ao teste\n"
...
void print_instructions_pt() {
  ...
  printf("\nA abordagem mais precisa para o teste é tomá-lo pelo ponto de "
         "vista do\n"
         "passado, como você tem sido pela maior parte de sua vida.\n"
         "Você deve entrar com a letra correspondente à frase que você deseja "
         "selecionar,\n"
         "sem os colchetes. Se você estiver inseguro do que escolher, você "
         "pode pular o\n"
         "par atual se entrar com [>].\n");

  printf("\nO perfil que você receberá do RHETI irá refletir as principais "
         "funções\n"
         "psicológicas da sua personalidade, a qual o equilíbrio muda com o "
         "tempo.\n"
         "O seu tipo básico de personalidade deve continuar o mesmo, mas "
         "outras funções\n"
  ...
  printf("\n%sATENÇÃO!%s A precisão desse teste será aumentada se você "
         ...
         "nosso eu ideal,\n"
         "e o eu como os outros nos veem. O RHETI está tentando discernir "
         "apenas o seu\n"
         "eu do passado. Portanto, é essencial que você mantenha o foco em "
         "responder\n"
         "apenas no seu eu do pasasdo, e não misturar o seu eu do passado, "
         "presente,\n"
         "ideal, ou social.\n",
         RED, RESET_C);
}
...
void print_result_pt(int a, int b, int c, int d, int e, int f, int g, int h,
                     int i) {
  ...
  if (wing_res > 0)
    ...
    printf("\nSeu tipo é provavelmente: %sTipo %hu do Eneagrama%s (asa não "
           "pôde ser calculada)\n",
